...
const projects = [
  {
    ...
    keyFeatures: "Disease detection, medicine suggestions, precaution tips, home remedies, diet and workout plans, admin dashboard",
    benefits: [
  ...
  },
  {
    ...
    details: "A comprehensive analysis of Indian Oil Corporations share price trends over time. It visualizes key metrics like open, close, high, and low prices, alongside adjusted close prices and trading volumes. It helps investors track performance and market trends.",
    image: "https://media.licdn.com/dms/image/v2/D5622AQHwjhHWcfLchw/feedshare-shrink_800/feedshare-shrink_800/0/1733425518066?e=1743638400&v=beta&t=ZxU7zvvtaE_fCa9-9VVrNt9jXwTAodtde-NkDBqc5cs",
    techStack: ["Power BI"],
    projectLink: "#"
  },
  {
